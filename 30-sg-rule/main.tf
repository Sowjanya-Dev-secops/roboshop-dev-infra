...
# redis accepting connection from bastion on port no 22
...
resource "aws_security_group_rule" "catalogue_backend_alb" {
  ...
  # this is the mistake we did, cart can not access catalouge direcly, it should be through backend-alb
...
resource "aws_security_group_rule" "backend_alb_payments" {
  type              = "ingress"
  security_group_id = local.backend_alb_sg_id
  source_security_group_id =  local.payment_sg_id
  from_port         = 80
